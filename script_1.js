...
function renderResult() {
  ...
  const mantouSprite = document.querySelector("#mantou-sprite");
  ...
  mantouSprite.style.transform = "none";
  mantouSprite.style.backgroundPosition = `${(result.sprite[0] / 5) * 100}% ${(result.sprite[1] / 3) * 100}%`;
  mantouSprite.setAttribute("aria-label", `${result.title}像素插画`);
}
